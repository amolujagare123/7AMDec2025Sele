...
public class JobLocationMultiList {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        WebElement multiText = driver.findElement(By.id("source_118"));
      ...
      Thread.sleep(4000);
        ...
        WebElement multiText2 = driver.findElement(By.id("fld_118"));

        selText = new Select(multiText2);
        selText.selectByIndex(1);
        selText.selectByIndex(2);
